...
const AboutUs = () => {
  return (
   ...
   <Header title='About Us' description='Hawkes is a trusted legal partner dedicated to helping clients navigate complex legal matters with clarity and confidence. We deliver practical, results-driven solutions tailored to your unique needs.'/>
    <div className='flex max-lg:flex-col items-center lg:px-16 max-lg:px-4 justify-center my-2'>
        <span className='flex flex-col lg:min-w-[400px] lg:border-r gap-y-3 px-6 lg:border-black lg:pe-12'>
            <h3 className='capitalize lg:text-4xl text-2xl my-4 font-bold heading'>About hawkes Legal</h3>
            <p className='leading-8 text-xs tracking-wide'>Hawkes Legal is a bespoke Nigerian law firm offering legal and business advisory services to a global clientele.  <br/>
...
Our team is versatile, resourceful and always willing to attend to every detail of our clients’ concerns.</p>
        ...
        <Image src='/justice.svg' width={12} height={12} className='object-contain max-lg:hidden block h-92 w-full' />
    </div>
    </>
  )
}
